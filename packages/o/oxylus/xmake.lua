package("oxylus")
    ...
    add_deps("miniaudio 0.11.24", {system = false})
    add_deps("fastgltf-ox v0.8.0", {system = false})
    add_deps("meshoptimizer v1.0.1", {system = false})
    add_deps("libsdl3 3.4.4", {})
    ...
    add_deps("vk-bootstrap v1.4.349", {debug=false,system=false})
    add_deps("vuk 2025.09.14.2", {configs={debug_allocations=false}})
    ...
    add_deps("joltphysics-ox a1ce83ec7f7e014b116a4855dfc9cb2f2d4ef40a", {configs={avx2=true,debug_renderer=true,tzcnt=true,sse4_1=true,sse4_2=true,avx=true,rtti=true,lzcnt=true,enable_floating_point_exceptions=false}})
