package("oxylus")
    ...
    add_deps("joltphysics v5.5.0", {configs={avx2=true,debug_renderer=true,tzcnt=true,sse4_1=true,sse4_2=true,avx=true,rtti=true,lzcnt=true,enable_floating_point_exceptions=false}})
