package("oxylus")
    ...
    add_deps("stb 2024.06.01", {system = false,private=true })
    add_deps("miniaudio 0.11.22", {system = false,private=true})
    add_deps("fastgltf-ox v0.8.0", {system = false,private=true})
    add_deps("meshoptimizer v0.22", {system = false,private=true})
    add_deps("libsdl3", {private=true})
    add_deps("ktx-ox v4.4.0", {system=false,private=true})
    add_deps("shader-slang v2025.15.1", {system=false,private=true})
    ...
    add_deps("vk-bootstrap v1.4.307", {debug=false,system=false,private=false})
    add_deps("vuk 2025.09.14.2", {configs={debug_allocations=false}, private=false})
    add_linkorders("vuk", {after = "Oxylus"})    
