package("oxylus")
    ...
    add_deps("fmt 11.2.0", {configs={shared=false,header_only=false},system=false})
    add_deps("plf_colony v7.41")
    add_deps("simdutf v6.2.0")
    add_deps("joltphysics-ox v5.4.0", {configs={avx2=true,debug_renderer=true,tzcnt=true,sse4_1=true,sse4_2=true,avx=true,rtti=true,lzcnt=true,enable_floating_point_exceptions=false}})
